  ...
  _createClass(Leaf, [{
    ...
    value: function renderMarks() {
      var _props2 = this.props,
          ...
          passProps = _props2.passProps;

      var leaf = this.renderText();

      return marks.reduce(function (children, mark) {
        var props = { mark: mark, marks: marks, node: node, offset: offset, text: text, children: children, passProps: passProps };
        var element = renderStack.renderMarks(props);
